...
function __wbg_adapter_28(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1fd7b879ff3e01f2(arg0, arg1);
}
...
export class AudioEngine {
    ...
    /**
     * @param {any} shared_buffer
     * @param {number} buffer_size
     * @param {number} sample_rate
     * @param {number} parallelism
     * @param {Waveform} waveform
     */
    constructor(shared_buffer, buffer_size, sample_rate, parallelism, waveform) {
        const ret = wasm.audioengine_new(shared_buffer, buffer_size, sample_rate, parallelism, waveform);
     ...
     */
    set_stats_callback(callback) {
        wasm.audioengine_set_stats_callback(this.__wbg_ptr, callback);
    }
    /**
     * @param {number} note
     */
    set_note(note) {
        wasm.audioengine_set_note(this.__wbg_ptr, note);
    }
    /**
     * @param {number} frequency
     */
    set_frequency(frequency) {
        wasm.audioengine_set_frequency(this.__wbg_ptr, frequency);
    }
    /**
     * @param {number} amplitude
     */
    set_amplitude(amplitude) {
        wasm.audioengine_set_amplitude(this.__wbg_ptr, amplitude);
    }
    /**
     * @returns {Promise<void>}
     */
    start() {
        const ret = wasm.audioengine_start(this.__wbg_ptr);
        return ret;
    }
    stop() {
        wasm.audioengine_stop(this.__wbg_ptr);
    }
    /**
     * @returns {bigint}
     */
    get_current_frame() {
        const ret = wasm.audioengine_get_current_frame(this.__wbg_ptr);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_byteLength_4dcad67f69497d91 = function(arg0) {
    ...
    imports.wbg.__wbg_getindex_88b2bccfad45a600 = function(arg0, arg1) {
        const ret = arg0[arg1 >>> 0];
        return ret;
    };
    imports.wbg.__wbg_instanceof_SharedArrayBuffer_8b668d71ffddfdc3 = function(arg0) {
        let result;
        try {
    ...
    imports.wbg.__wbg_newwithbyteoffset_77df312fc86b3ff4 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('microbe_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
